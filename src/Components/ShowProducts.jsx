            ...
            <div className="col-lg-4 col-md-6 pb-1" key={P._id}>
                <div className="cat-item d-flex flex-column border mb-4" style={{padding: '30px'}}>
                    ...
                    <Link to={{pathname: `/product/edit/${P.productTag}`}} className="cat-img position-relative overflow-hidden mb-3"
                        state={{ _id : P._id, productName : P.productName, productTag : P.productTag, productImages : P.productImages, 
                        productPrice : P.productPrice, productColor : P.productColor, productSummary : P.productSummary, 
                        ...
                        <img className="img-fluid" src={P.productImages[0]} alt=""/>
                    </Link>
